...
type txnCrossProcess struct {
	...
	InboundMetadata crossProcessMetadata
...
type crossProcessMetadata struct {
	...
	PinpointTraceid        string
	PinpointPappname       string
	PinpointPapptype       int16
	PinpointPspanid        int64
	PinpointSpanid         int64
	PinpointFlags          string
	PinpointTraceidEncoded []byte
}
