...
import (
	...
	"github.com/dingyalin/pinpoint-go-agent/internal/stacktracetest"
)
...
func TestStacktraceFrames(t *testing.T) {
	...
	inputFrames := []stacktraceFrame{
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/internal/stacktrace.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/internal.GetStackTrace",
			Line: 18,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/internal_txn.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/pinpoint.errDataFromError",
			Line: 533,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/internal_txn.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/pinpoint.(*txn).NoticeError",
			Line: 575,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/transaction.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/pinpoint.(*Transaction).NoticeError",
			Line: 90,
		},
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/examples/server/main.go",
		...
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/instrumentation.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/pinpoint.WrapHandle.func1",
			Line: 41,
		},
		{
			File: "/Users/will/.gvm/gos/go1.13/src/net/http/server.go",
		...
		{
			File: "/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/instrumentation.go",
			Name: "github.com/dingyalin/pinpoint-go-agent/pinpoint.WrapHandleFunc.func1",
			Line: 71,
		},
		{
			File: "/Users/will/.gvm/gos/go1.13/src/net/http/server.go",
	...
	expectedJSON := `[
		{
			"name":"main.noticeError",
			"filepath":"/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/examples/server/main.go",
			"line":30
		},
		{
		...
		{
			"name":"pinpoint.WrapHandle.func1",
			"filepath":"/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/instrumentation.go",
			"line":41
		},
		{
			"name":"http.HandlerFunc.ServeHTTP",
		...
		{
			"name":"pinpoint.WrapHandleFunc.func1",
			"filepath":"/Users/will/Desktop/gopath/src/github.com/dingyalin/pinpoint-go-agent/pinpoint/instrumentation.go",
			"line":71
		},
		{
...
func TestStackTraceTopFrame(t *testing.T) {
	...
	// the top stack frames which are in packages "pinpoint" and "internal".
