...
// (https://godoc.org/github.com/dingyalin/pinpoint-go-agent/integrations) directory --
...
// (https://godoc.org/github.com/dingyalin/pinpoint-go-agent/newrelic#Transaction.AddAttribute)
