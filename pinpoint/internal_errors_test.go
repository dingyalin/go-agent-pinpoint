...
func TestNoticeErrorBackground(t *testing.T) {
	...
	app.ExpectErrors(t, []internal.WantError{{
		...
		Msg:     "my msg",
		Klass:   "pinpoint.myError",
	}})
	app.ExpectErrorEvents(t, []internal.WantEvent{{
		Intrinsics: map[string]interface{}{
			"error.class":     "pinpoint.myError",
...
func TestErrorWithClasserReturnsEmpty(t *testing.T) {
	...
	app.ExpectErrors(t, []internal.WantError{{
		TxnName: "OtherTransaction/Go/hello",
		Msg:     "my msg",
		Klass:   "pinpoint.errorWithClass",
	}})
	app.ExpectErrorEvents(t, []internal.WantEvent{{
		Intrinsics: map[string]interface{}{
			"error.class":     "pinpoint.errorWithClass",
			"error.message":   "my msg",
			"transactionName": "OtherTransaction/Go/hello",
		},
	}})
...
func TestErrorWithStackTrace(t *testing.T) {
	...
	app.ExpectErrors(t, []internal.WantError{{
		TxnName: "OtherTransaction/Go/hello",
		Msg:     "my msg",
		Klass:   "pinpoint.withStackTrace",
	}})
	app.ExpectErrorEvents(t, []internal.WantEvent{{
		Intrinsics: map[string]interface{}{
			"error.class":     "pinpoint.withStackTrace",
			"error.message":   "my msg",
			"transactionName": "OtherTransaction/Go/hello",
		},
	}})
...
func TestErrorClass(t *testing.T) {
	...
	testcases := []struct {
		...
		{Error: basicError{}, Expect: "pinpoint.basicError"},
		{Error: errWithClass("zap"), Expect: "zap"},
		{Error: errWithClass(""), Expect: "pinpoint.withClass"},
		{Error: wrapWithClass(errWithClass("zap"), "zip"), Expect: "zip"},
		{Error: wrapWithClass(errWithClass("zap"), ""), Expect: "zap"},
		{Error: wrapWithClass(errWithClass(""), ""), Expect: "pinpoint.withClass"},
		{Error: wrapError(basicError{}), Expect: "pinpoint.basicError"},
